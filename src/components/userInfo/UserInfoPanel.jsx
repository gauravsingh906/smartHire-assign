    ...
    return (
        <div className="w-[24%] p-2 bg-white min-h-screen border-gray-100">
            ...
            <div className="text-center mb-6">
                <div className="relative inline-block">
                    <div className="w-20 p-1 h-20 bg-[#bae6fd] rounded-full mb-2">
                        <Image src="/profile.png" alt="Profile" width={90} height={90} className="rounded-full" />
                    </div>
            ...
            <div className="grid grid-cols-3 gap-2 mb-6">
                {['Call', 'Video', 'More'].map(action => (
                    <button
                        key={action}
                        className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-lg transition-transform transform hover:scale-105"
                    >
                        {action === 'Call' && <Phone className="w-5 h-5 text-gray-600 mb-1" />}
                        {action === 'Video' && <Video className="w-5 h-5 text-gray-600 mb-1" />}
                        {action === 'More' && <MoreHorizontal className="w-5 h-5 text-gray-600 mb-1" />}
